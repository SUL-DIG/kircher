...
class CatalogController < ApplicationController  
  ...
  configure_blacklight do |config|
    ...
    # facet bar
    config.add_facet_field 'volume', :label => 'Volume/APUG', :limit => 20, :sort => 'index' 
    ...
    config.add_index_field 'names_facet', :label => 'Name(s):' 
    config.add_index_field 'places_facet', :label => 'Place(s):' 
